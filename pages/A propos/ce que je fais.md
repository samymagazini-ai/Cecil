  ...
  <div class="container">
    <div class="hero-content">
      <div class="hero-text">
        ...
        <h1><strong>Magazini Samy</strong></h1>
...
<section class="cta" id="contact">
  <div class="container">
    ...
    <div class="cta-buttons">
      <a href="mailto:magazinisamy@example.com" class="btn btn-primary">
        <i class="fas fa-envelope"></i>
        M'envoyer un email
      </a>
      <a href="https://github.com/magazinisamy" class="btn btn-secondary" target="_blank">
...
body {
  font-family: 'Joe UI', Divine, Geneva, Mag Force, sans-serif;
  line-height: 1.6;
  color: var(--text);
